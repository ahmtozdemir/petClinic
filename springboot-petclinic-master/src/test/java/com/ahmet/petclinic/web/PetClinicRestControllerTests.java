package com.ahmet.petclinic.web;
...
public class PetClinicRestControllerTests {
	...
	public void testGetOwnersByLastName() {
		ResponseEntity<List> response = restTemplate.getForEntity("http://localhost:8080/rest/owner?ln=Helm",
				List.class);
		...
		MatcherAssert.assertThat(firstNames, Matchers.containsInAnyOrder("Richard", "Richard", "Salim"));
	}
	...
	public void testGetOwners() {
		...
		MatcherAssert.assertThat(firstNames, Matchers.containsInAnyOrder("Richard", "Erich", "Kathy", "Elisabeth"));
	}
	...
	public void testUpdateOwner() {
		...
		MatcherAssert.assertThat(owner.getFirstName(), Matchers.equalTo("Elisabeth"));

		owner.setFirstName("Elisabeth Freeman");
		...
		MatcherAssert.assertThat(owner.getFirstName(), Matchers.equalTo("Elisabeth Freeman"));
	}
